...
class BaseResRNNModel(torch.nn.Module):
    ...
    layer(s). Output vectors of residual RNN layer(s) then go through
    ...
    Args:
        d_emb:
            ...
            `1`.
        d_hid:
            Residual RNN layers hidden dimension. Must be bigger than or equal
            to `1`.
        dropout:
        ...
        num_linear_layers:
            ...
            `1`.
        num_rnn_layers:
            Number of residual RNN layers to use. Must be bigger than or equal
            to `1`.
        pad_token_id:
