r"""Language model with self-attention residual LSTM layers.
...
class SelfAttentionResLSTMModel(BaseSelfAttentionResRNNModel):
    r"""Language model with self-attention residual LSTM blocks.
    ...
    of residual LSTM layer(s).Passing query, key, value vector to do self
