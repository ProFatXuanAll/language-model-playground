    ...
    for epoch in range(config.epoch):
        ...
        for x, y in mini_batch_iterator:
            ...
            if step % config.checkpoint == 0:
                torch.save(model.state_dict(), f'{save_path}/model{step/config.checkpoint}.ckpt')
                model_num += 1
...
if  __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate",      type=float, default=5e-5,   help="Optimizer's parameter `lr`.")
    ...
    parser.add_argument("--model_type",         type=str,   default='lstm', help="Decide use which model, GRU or LSTM")
    ...
    parser.add_argument("--tokenizer_type",     type=str,   default='list', help="Decide use which tokenizer, List or Dict")
