r"""Test `lmp.model.SelfAttentionResGRUModel.forward`.

Usage:
    python -m unittest test.lmp.model._self_attention_res_gru_model.test_forward
"""
...
class TestForward(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionResGRUModel.forward`."""
    ...
    def setUp(self):
        r"""Setup hyperparameters and construct `_self_attention_res_gru_model`."""
        self.model_objs = []
        cls = self.__class__
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionResGRUModel.forward),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
