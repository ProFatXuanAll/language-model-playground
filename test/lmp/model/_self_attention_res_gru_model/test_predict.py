r"""Test `lmp.model.SelfAttentionResGRUModel.predict`.

Usage:
    python -m unittest test.lmp.model._self_attention_res_gru_model.test_predict
"""
...
class TestPredict(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionResGRUModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionResGRUModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
