r"""Test `lmp.model.SelfAttentionResLSTMModel.__init__`.

Usage:
    python -m unittest test.lmp.model._self_attention_res_lstm_model.test_init
"""
...
from lmp.model import SelfAttentionResLSTMModel


class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionResLSTMModel.__init__`."""
    ...
    def setUp(self):
        r"""Setup hyperparameters and construct `SelfAttentionResLSTMModel`."""
        self.model_objs = []
        cls = self.__class__
        ...
        for (
            ...
            if vocab_size <= pad_token_id:
                continue
            model = SelfAttentionResLSTMModel(
                d_emb=d_emb,
                d_hid=d_hid,
                dropout=dropout,
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionResLSTMModel.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_residual_rnn_layer(self):
        ...
        msg = 'Must declare correct residual LSTM layer(s).'
        examples = (
            (
        ...
        for rnn_layer, d_hid, dropout, num_rnn_layers in examples:
            ...
            for layer in rnn_layer:
                self.assertIsInstance(layer, ResLSTMBlock, msg=msg)
