r"""Test `lmp.model.SelfAttentionResLSTMModel.predict`.

Usage:
    python -m unittest test.lmp.model._self_attention_res_lstm_model.test_predict
"""
...
class TestPredict(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionResLSTMModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionResLSTMModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
