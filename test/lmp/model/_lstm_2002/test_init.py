...
def test_lstm_2002_layer_default_value() -> None:
  ...
  assert hasattr(lstm_2002_layer, 'd_blk')
  assert lstm_2002_layer.d_blk == d_blk

  assert hasattr(lstm_2002_layer, 'd_hid')
  assert lstm_2002_layer.d_hid == n_blk * d_blk

  assert hasattr(lstm_2002_layer, 'in_feat')
  assert lstm_2002_layer.in_feat == in_feat

  assert hasattr(lstm_2002_layer, 'init_fb')
  assert math.isclose(lstm_2002_layer.init_fb, init_fb)

  assert hasattr(lstm_2002_layer, 'init_ib')
  assert math.isclose(lstm_2002_layer.init_ib, init_ib)

  assert hasattr(lstm_2002_layer, 'init_lower')
  assert math.isclose(lstm_2002_layer.init_lower, init_lower)

  assert hasattr(lstm_2002_layer, 'init_ob')
  assert math.isclose(lstm_2002_layer.init_ob, init_ob)

  assert hasattr(lstm_2002_layer, 'init_upper')
  assert math.isclose(lstm_2002_layer.init_upper, init_upper)

  assert hasattr(lstm_2002_layer, 'n_blk')
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_x2fg.weight) & (lstm_2002_layer.fc_x2fg.weight <= init_upper))
  assert torch.all((0 <= lstm_2002_layer.fc_x2fg.bias) & (lstm_2002_layer.fc_x2fg.bias <= init_fb))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_x2ig.weight) & (lstm_2002_layer.fc_x2ig.weight <= init_upper))
  assert torch.all((init_ib <= lstm_2002_layer.fc_x2ig.bias) & (lstm_2002_layer.fc_x2ig.bias <= 0))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_x2og.weight) & (lstm_2002_layer.fc_x2og.weight <= init_upper))
  assert torch.all((init_ob <= lstm_2002_layer.fc_x2og.bias) & (lstm_2002_layer.fc_x2og.bias <= 0))
  ...
  assert torch.all(
    (init_lower <= lstm_2002_layer.fc_x2mc_in.weight) & (lstm_2002_layer.fc_x2mc_in.weight <= init_upper)
  )
  assert torch.all((init_lower <= lstm_2002_layer.fc_x2mc_in.bias) & (lstm_2002_layer.fc_x2mc_in.bias <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_h2fg.weight) & (lstm_2002_layer.fc_h2fg.weight <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_h2ig.weight) & (lstm_2002_layer.fc_h2ig.weight <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.fc_h2og.weight) & (lstm_2002_layer.fc_h2og.weight <= init_upper))
  ...
  assert torch.all(
    (init_lower <= lstm_2002_layer.fc_h2mc_in.weight) & (lstm_2002_layer.fc_h2mc_in.weight <= init_upper)
  )
  ...
  assert torch.all((init_lower <= lstm_2002_layer.pc_c2fg) & (lstm_2002_layer.pc_c2fg <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.pc_c2ig) & (lstm_2002_layer.pc_c2ig <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002_layer.pc_c2og) & (lstm_2002_layer.pc_c2og <= init_upper))

  assert hasattr(lstm_2002_layer, 'c_0')
  assert isinstance(lstm_2002_layer.c_0, torch.Tensor)
  assert lstm_2002_layer.c_0.size() == torch.Size([1, n_blk, d_blk])
  assert torch.all(lstm_2002_layer.c_0 == 0.0)

  assert hasattr(lstm_2002_layer, 'h_0')
  assert isinstance(lstm_2002_layer.h_0, torch.Tensor)
  assert lstm_2002_layer.h_0.size() == torch.Size([1, n_blk * d_blk])
  assert torch.all(lstm_2002_layer.h_0 == 0.0)
...
def test_lstm_2002_default_value(tknzr: BaseTknzr) -> None:
  """Ensure default value consistency."""
  d_emb = 1
  d_blk = 1
  init_fb = 1.0
  ...
  p_emb = 0.0
  p_hid = 0.0
  lstm_2002 = LSTM2002(tknzr=tknzr)
  lstm_2002.params_init()

  assert hasattr(lstm_2002, 'd_blk')
  assert lstm_2002.d_blk == d_blk

  assert hasattr(lstm_2002, 'd_emb')
  assert lstm_2002.d_emb == d_emb

  assert hasattr(lstm_2002, 'd_hid')
  assert lstm_2002.d_hid == n_blk * d_blk

  assert hasattr(lstm_2002, 'init_fb')
  assert math.isclose(lstm_2002.init_fb, init_fb)

  assert hasattr(lstm_2002, 'init_ib')
  assert math.isclose(lstm_2002.init_ib, init_ib)

  assert hasattr(lstm_2002, 'init_lower')
  assert math.isclose(lstm_2002.init_lower, init_lower)

  assert hasattr(lstm_2002, 'init_ob')
  assert math.isclose(lstm_2002.init_ob, init_ob)

  assert hasattr(lstm_2002, 'init_upper')
  assert math.isclose(lstm_2002.init_upper, init_upper)

  assert hasattr(lstm_2002, 'label_smoothing')
  assert math.isclose(lstm_2002.label_smoothing, label_smoothing)
  ...
  assert torch.all((init_lower <= lstm_2002.emb.weight) & (lstm_2002.emb.weight <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002.fc_e2h[1].weight) & (lstm_2002.fc_e2h[1].weight <= init_upper))
  assert torch.all((init_lower <= lstm_2002.fc_e2h[1].bias) & (lstm_2002.fc_e2h[1].bias <= init_upper))
  ...
  assert torch.all((init_lower <= lstm_2002.fc_h2e[0].weight) & (lstm_2002.fc_h2e[0].weight <= init_upper))
  assert torch.all((init_lower <= lstm_2002.fc_h2e[0].bias) & (lstm_2002.fc_h2e[0].bias <= init_upper))
