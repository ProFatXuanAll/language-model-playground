"""Test :py:class:`lmp.model._res_sattn_rnn` signatures."""
...
def test_inherent_method():
  ...
  assert (inspect.signature(SAttnRNNModel.forward) == inspect.signature(ResSAttnRNNModel.forward))

  assert (inspect.signature(SAttnRNNModel.load) == inspect.signature(ResSAttnRNNModel.load))

  assert (inspect.signature(SAttnRNNModel.loss_fn) == inspect.signature(ResSAttnRNNModel.loss_fn))

  assert (inspect.signature(SAttnRNNModel.pred) == inspect.signature(ResSAttnRNNModel.pred))

  assert (inspect.signature(SAttnRNNModel.ppl) == inspect.signature(ResSAttnRNNModel.ppl))

  assert (inspect.signature(SAttnRNNModel.save) == inspect.signature(ResSAttnRNNModel.save))

  assert (inspect.signature(SAttnRNNModel.train_parser) == inspect.signature(ResSAttnRNNModel.train_parser))
