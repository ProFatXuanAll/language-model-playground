r"""Test `lmp.model.GRUModel.predict`.

Usage:
    python -m unittest test/lmp/model/_gru_model/test_predict.py
"""
...
class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.GRUModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(GRUModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
