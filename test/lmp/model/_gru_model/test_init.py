r"""Test `lmp.model.GRUModel.__init__`.

Usage:
    python -m unittest test.lmp.model._gru_model.test_init
"""
...
class TestInit(unittest.TestCase):
    ...
    def test_gru_layer(self):
        r"""Declare correct GRU layer(s)."""
        msg = 'Must declare correct GRU layer(s).'
        examples = (
            (
