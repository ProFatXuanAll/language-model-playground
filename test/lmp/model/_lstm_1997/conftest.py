...
@pytest.fixture
def lstm_1997(d_blk: int, d_emb: int, n_blk: int, p_emb: float, p_hid: float, tknzr: BaseTknzr) -> LSTM1997:
  """:py:class:`lmp.model._lstm_1997.LSTM1997` instance."""
  return LSTM1997(d_blk=d_blk, d_emb=d_emb, n_blk=n_blk, p_emb=p_emb, p_hid=p_hid, tknzr=tknzr)
