...
Test target:
- :py:meth:`lmp.model._lstm_1997.LSTM1997.cal_loss`.
"""
...
def test_cal_loss(lstm_1997: LSTM1997, batch_cur_tkids: torch.Tensor, batch_next_tkids: torch.Tensor) -> None:
  ...
  for idx in range(batch_cur_tkids.size(1)):
    loss, batch_cur_states = lstm_1997.cal_loss(
