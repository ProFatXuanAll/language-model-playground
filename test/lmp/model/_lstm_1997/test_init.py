...
def test_parameters(d_blk: int, d_emb: int, n_blk: int, tknzr: BaseTknzr, lstm_1997: LSTM1997) -> None:
  ...
  assert lstm_1997.proj_e2c.weight.size() == torch.Size([n_blk * (2 + d_blk), d_emb])
  assert lstm_1997.proj_e2c.bias.size() == torch.Size([n_blk * (2 + d_blk)])
  ...
  assert lstm_1997.proj_h2c.weight.size() == torch.Size([n_blk * (2 + d_blk), n_blk * d_blk])
  ...
  assert lstm_1997.proj_h2e.weight.size() == torch.Size([d_emb, n_blk * d_blk])
