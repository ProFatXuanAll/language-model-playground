r"""Test `lmp.model.LSTMModel.predict`.

Usage:
    python -m unittest test/lmp/model/_lstm_model/test_predict.py
"""
...
class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.LSTMModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(LSTMModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
