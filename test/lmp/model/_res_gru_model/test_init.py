...
Usage:
    python -m unittest test.lmp.model._res_gru_model.test_init
"""
...
class TestInit(unittest.TestCase):
    ...
    def test_inherit(self):
        r""""Is subclass of `lmp.model.BaseResRNNModel`."""
        msg = 'Must be subclass of `lmp.model.BaseResRNNModel`.'

        for model_obj in self.model_objs:
            self.assertIsInstance(model_obj['model'], BaseResRNNModel, msg=msg)
    ...
    def test_residual_gru_layer(self):
