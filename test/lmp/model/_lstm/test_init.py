"""Test the construction of :py:class:`lmp.model.LSTMModel`.
...
def test_loss(lstm_model: LSTMModel):
  """Test loss function
    ...
    """
  # Type check
  assert isinstance(lstm_model.loss_ignore_padding, nn.CrossEntropyLoss)
