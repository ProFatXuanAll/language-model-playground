"""Test loss function of LSTM language model.
...
def test_input_shape_and_dtype(
  ...
  """Input tensors must be long tensors and have the same shape.
...
def test_return_shape_and_dtype(
  ...
  """Return float tensor with 0 dimension."""
  lstm_model = lstm_model.eval()
...
def test_back_propagation_path(
  ...
  """Gradients with respect to loss must get back propagated."""
