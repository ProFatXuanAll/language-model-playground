r"""Test `lmp.model.BaseRNNModel.forward`.

Usage:
    python -m unittest test.lmp.model._base_rnn_model.test_forward
"""
...
class TestForward(unittest.TestCase):
    r"""Test case for `lmp.model.BaseRNNModel.forward`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseRNNModel.forward),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
