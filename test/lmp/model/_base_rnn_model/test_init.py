r"""Test `lmp.model.BaseRNNModel.__init__`.

Usage:
    python -m unittest test.lmp.model._base_rnn_model.test_init
"""
...
class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.BaseRNNModel.__init__`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseRNNModel.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
