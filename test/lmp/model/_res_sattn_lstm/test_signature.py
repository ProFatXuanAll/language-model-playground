"""Test :py:class:`lmp.model._res_sattn_lstm` signatures."""
...
def test_inherent_method():
  ...
  assert (inspect.signature(ResSAttnRNNModel.forward) == inspect.signature(ResSAttnLSTMModel.forward))

  assert (inspect.signature(ResSAttnRNNModel.load) == inspect.signature(ResSAttnLSTMModel.load))

  assert (inspect.signature(ResSAttnRNNModel.loss_fn) == inspect.signature(ResSAttnLSTMModel.loss_fn))

  assert (inspect.signature(ResSAttnRNNModel.pred) == inspect.signature(ResSAttnLSTMModel.pred))

  assert (inspect.signature(ResSAttnRNNModel.ppl) == inspect.signature(ResSAttnLSTMModel.ppl))

  assert (inspect.signature(ResSAttnRNNModel.save) == inspect.signature(ResSAttnLSTMModel.save))

  assert (inspect.signature(ResSAttnRNNModel.train_parser) == inspect.signature(ResSAttnLSTMModel.train_parser))
