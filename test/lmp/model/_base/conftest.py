"""Setup fixtures for testing :py:mod:`lmp.model.BaseModel`."""
...
def subclss_model_clss() -> Type[BaseModel]:
  ...
  class SubclssModel(BaseModel):
    """Only implement ``forward`` and ``loss_fn`` and ``pred``."""
...
@pytest.fixture
def subclss_model(subclss_model_clss: Type[BaseModel],):
  """Simple ``BaseModel`` subclass instance."""
