r"""Test `lmp.model.SelfAttentionLSTMModel.__init__`.

Usage:
    python -m unittest test.lmp.model._self_attention_lstm_model.test_init
"""
...
from lmp.model import SelfAttentionLSTMModel


class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionLSTMModel.__init__`."""
    ...
    def setUp(self):
        r"""Setup hyperparameters and construct `SelfAttentionLSTMModel`."""
        self.model_objs = []
        cls = self.__class__
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionLSTMModel.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
