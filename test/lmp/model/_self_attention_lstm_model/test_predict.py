r"""Test `lmp.model.SelfAttentionLSTMModel.predict`.

Usage:
    python -m unittest test.lmp.model._self_attention_lstm_model.test_predict
"""
...
class TestPredict(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionLSTMModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionLSTMModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
