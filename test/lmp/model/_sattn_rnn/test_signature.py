"""Test :py:class:`lmp.model._sattn_rnn` signatures."""
...
def test_inherent_method():
  ...
  assert (inspect.signature(RNNModel.forward) == inspect.signature(SAttnRNNModel.forward))

  assert (inspect.signature(RNNModel.load) == inspect.signature(SAttnRNNModel.load))

  assert (inspect.signature(RNNModel.loss_fn) == inspect.signature(SAttnRNNModel.loss_fn))

  assert (inspect.signature(RNNModel.pred) == inspect.signature(SAttnRNNModel.pred))

  assert (inspect.signature(RNNModel.ppl) == inspect.signature(SAttnRNNModel.ppl))

  assert (inspect.signature(RNNModel.save) == inspect.signature(SAttnRNNModel.save))

  assert (inspect.signature(RNNModel.train_parser) == inspect.signature(SAttnRNNModel.train_parser))
