...
def lstm_2000(
  ...
  return LSTM2000(d_blk=d_blk, d_emb=d_emb, n_blk=n_blk, n_lyr=n_lyr, p_emb=p_emb, p_hid=p_hid, tknzr=tknzr)


@pytest.fixture
def lstm_2000_layer(d_blk: int, in_feat: int, n_blk: int) -> LSTM2000Layer:
  """:py:class:`lmp.model._lstm_2000.LSTM2000Layer` instance."""
  return LSTM2000Layer(d_blk=d_blk, in_feat=in_feat, n_blk=n_blk)
...
@pytest.fixture
def batch_x(lstm_2000_layer: LSTM2000Layer) -> torch.Tensor:
