r"""Test `lmp.model.BaseSelfAttentionResRNNModel.__init__`.

Usage:
    python -m unittest test.lmp.model._base_self_attention_res_rnn_model.test_init
"""
...
class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.BaseSelfAttentionResRNNModel.__init__`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseSelfAttentionResRNNModel.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_residual_rnn_layer(self):
        r"""Declare correct residual RNN layer(s)."""
        msg = 'Must declare correct residual RNN layer(s).'
        examples = (
            (
        ...
        for rnn_layer, d_hid, dropout, num_rnn_layers in examples:
            ...
            for layer in rnn_layer:
                self.assertIsInstance(layer, BaseResRNNBlock, msg=msg)
