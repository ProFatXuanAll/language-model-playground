r"""Test `lmp.model.SelfAttentionGRUModel.predict`.

Usage:
    python -m unittest test.lmp.model._self_attention_gru_model.test_predict
"""
...
class TestPredict(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionGRUModel.predict`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionGRUModel.predict),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
