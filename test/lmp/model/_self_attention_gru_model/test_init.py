r"""Test `lmp.model.SelfAttentionGRUModel.__init__`.

Usage:
    python -m unittest test.lmp.model._self_attention_gru_model.test_init
"""
...
from lmp.model import SelfAttentionGRUModel


class TestInit(unittest.TestCase):
    r"""Test case for `lmp.model.SelfAttentionGRUModel.__init__`."""
    ...
    def setUp(self):
        r"""Setup hyperparameters and construct `SelfAttentionGRUModel`."""
        self.model_objs = []
        cls = self.__class__
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(SelfAttentionGRUModel.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_rnn_layer(self):
        r"""Declare correct RNN layer(s)."""
        msg = 'Must declare correct RNN layer(s).'
        examples = (
            (
        ...
        for rnn_layer, d_hid, dropout, num_rnn_layers in examples:
            self.assertIsInstance(rnn_layer, torch.nn.GRU, msg=msg)
