...
def test_inherent_instance_method() -> None:
  ...
  assert lmp.tknzr._ws.WsTknzr.batch_dec == BaseTknzr.batch_dec
  assert lmp.tknzr._ws.WsTknzr.batch_enc == BaseTknzr.batch_enc
  ...
  assert lmp.tknzr._ws.WsTknzr.trunc_to_max == BaseTknzr.trunc_to_max
