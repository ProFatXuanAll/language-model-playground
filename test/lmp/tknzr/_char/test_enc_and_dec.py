...
def test_cased_enc() -> None:
  ...
  # Padding.
  tknzr.max_seq_len = 5
  assert tknzr.enc(txt='aA') == [BOS_TKID, tknzr.tk2id['a'], tknzr.tk2id['A'], EOS_TKID, PAD_TKID]

  # Truncate.
  tknzr.max_seq_len = 3
  assert tknzr.enc(txt='aA') == [BOS_TKID, tknzr.tk2id['a'], tknzr.tk2id['A']]
  ...
  tknzr.max_seq_len = 5
  assert tknzr.enc(txt='bB') == [BOS_TKID, UNK_TKID, UNK_TKID, EOS_TKID, PAD_TKID]

  # Unknown tokens with truncation.
  tknzr.max_seq_len = 2
  assert tknzr.enc(txt='bB') == [BOS_TKID, UNK_TKID]
