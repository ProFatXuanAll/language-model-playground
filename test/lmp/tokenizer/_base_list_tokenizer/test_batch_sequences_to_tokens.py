r"""Test `lmp.tokenizer.BaseListTokenizer.batch_sequences_to_tokens`.
...
class TestBatchSequencesToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseListTokenizer.batch_sequences_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseListTokenizer.batch_sequences_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
