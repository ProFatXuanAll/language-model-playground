r"""Test `lmp.tokenizer.BaseListTokenizer.batch_tokens_to_sequences`.
...
class TestBatchTokensToSequences(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseListTokenizer.batch_tokens_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseListTokenizer.batch_tokens_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
