...
Usage:
    python -m unittest test.lmp.tokenizer._base_list_tokenizer.test_init
"""
...
class TestInit(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseListTokenizer.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_invalid_input_is_uncased(self):
        ...
        for invalid_input in examples:
            with self.assertRaises(TypeError, msg=msg1) as ctx_man:
                BaseListTokenizer(is_uncased=invalid_input)
