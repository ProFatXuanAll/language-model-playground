r"""Test `lmp.tokenizer.BaseListTokenizer.convert_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_list_tokenizer/test_convert_tokens_to_ids.py
"""
...
class TestConvertTokensToIds(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseListTokenizer.convert_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
