r"""Test `lmp.tokenizer.WhitespaceListTokenizer.__init__`.

Usage:
    python -m unittest test.lmp.tokenizer._whitespace_list_tokenizer.test_init
"""
...
class TestInit(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.__init__`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
