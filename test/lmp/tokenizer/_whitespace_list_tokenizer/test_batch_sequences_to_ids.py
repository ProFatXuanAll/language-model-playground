r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_sequences_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_sequences_to_ids.py
"""
...
class TestBatchSequencesToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.batch_sequences_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.batch_sequences_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_invalid_input_batch_sequences(self):
        ...
        examples = (
            ...
            object(), lambda x: x, type, None, NotImplemented, ..., 0j, 1j,
        )
