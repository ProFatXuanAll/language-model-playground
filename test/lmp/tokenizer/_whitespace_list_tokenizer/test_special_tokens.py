...
Usage:
    python -m unittest \
        test.lmp.tokenizer._whitespace_list_tokenizer.test_special_tokens
"""
...
class TestSpecialTokens(unittest.TestCase):
    ...
    def test_yield_value(self):
        ...
        self.assertIsInstance(
            WhitespaceListTokenizer.special_tokens(),
            Iterator,
            msg=msg
        )

        out_tokens = list(WhitespaceListTokenizer.special_tokens())
