r"""Test `lmp.tokenizer.WhitespaceListTokenizer.normalize`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_normalize.py
"""
...
class TestNormalize(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.normalize`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.normalize),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
