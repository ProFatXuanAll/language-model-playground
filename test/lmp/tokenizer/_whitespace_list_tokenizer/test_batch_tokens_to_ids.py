r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_tokens_to_ids.py
"""
...
class TestBatchTokensToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.batch_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.batch_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
