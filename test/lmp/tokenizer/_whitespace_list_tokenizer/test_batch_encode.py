r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_encode`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_encode.py
"""
...
class TestBatchEncode(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.batch_encode`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.batch_encode),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_prefix_postfix(self):
        ...
        [EOS] id."""
        msg = (
            'Return result must include [BOS] id and [EOS] id for each '
            'tokens_ids.'
        )
        examples = (
            (
