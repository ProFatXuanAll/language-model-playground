r"""Test `lmp.tokenizer.WhitespaceListTokenizer.convert_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_convert_tokens_to_ids.py
"""
...
class TestConvertTokensToIds(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.WhitespaceListTokenizer.convert_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.convert_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
