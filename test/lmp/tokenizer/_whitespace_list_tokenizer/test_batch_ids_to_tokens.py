r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_ids_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_ids_to_tokens.py
"""
...
class TestBatchIdsToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.batch_ids_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.batch_ids_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_invalid_input_batch_token_ids(self):
        ...
        examples = (
            0, 1, -1, 0.0, 1.0, math.nan, math.inf, True, False, None, 0j, 1j,
