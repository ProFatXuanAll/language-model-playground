r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_ids_to_sequences`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_ids_to_sequences.py
"""
...
class TestBatchIdsToSequences(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.WhitespaceListTokenizer.batch_ids_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.batch_ids_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
