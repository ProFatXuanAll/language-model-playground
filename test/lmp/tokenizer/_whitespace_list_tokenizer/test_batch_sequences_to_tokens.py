r"""Test `lmp.tokenizer.WhitespaceListTokenizer.batch_sequences_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_list_tokenizer/test_batch_sequences_to_tokens.py
"""
...
class TestBatchSequencesToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceListTokenizer.batch_sequences_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(
                WhitespaceListTokenizer.batch_sequences_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
