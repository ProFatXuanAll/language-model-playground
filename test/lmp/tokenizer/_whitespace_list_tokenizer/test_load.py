r"""Test `lmp.tokenizer.WhitespaceListTokenizer.load`.

Usage:
    python -m unittest test.lmp.tokenizer._whitespace_list_tokenizer.test_load
"""
...
class TestLoad(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceListTokenizer.load),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='experiment',
    ...
    def test_invalid_input_experiment(self):
        ...
        for invalid_input in examples:
            with self.assertRaises(
                ...
                WhitespaceListTokenizer.load(experiment=invalid_input)
    ...
    def test_experiment_does_not_exist(self):
        ...
        for experiment in examples:
            with self.assertRaises(FileNotFoundError, msg=msg1) as ctx_man:
                WhitespaceListTokenizer.load(experiment=experiment)
    ...
    def test_load_result(self):
        ...
        for obj in examples:
            try:
                ...
                tokenizer = WhitespaceListTokenizer.load(
                    experiment=self.__class__.experiment
                )

                self.assertIsInstance(
                    tokenizer, WhitespaceListTokenizer, msg=msg)
