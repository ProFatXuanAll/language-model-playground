r"""Test `lmp.tokenizer.BaseDictTokenizer.convert_ids_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_dict_tokenizer/test_convert_ids_to_tokens.py
"""
...
class TestConvertIdsToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseDictTokenizer.convert_ids_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.convert_ids_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
