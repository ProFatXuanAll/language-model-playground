r"""Test `lmp.tokenizer.BaseDictTokenizer.batch_ids_to_sequences`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_dict_tokenizer/test_batch_ids_to_sequences.py
"""
...
class TestBatchIdsToSequences(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.BaseDictTokenizer.batch_ids_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.batch_ids_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
