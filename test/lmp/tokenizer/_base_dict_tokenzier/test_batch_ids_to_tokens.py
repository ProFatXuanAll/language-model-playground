r"""Test `lmp.tokenizer.BaseDictTokenizer.batch_ids_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_dict_tokenizer/test_batch_ids_to_tokens.py
"""
...
class TestBatchIdsToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseDictTokenizer.batch_ids_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.batch_ids_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
        ...
        for invalid_input in examples:
            for tokenizer in self.tokenizers:
                ...
                self.assertEqual(
                    ...
                    '`batch_token_ids` must be instance of '
