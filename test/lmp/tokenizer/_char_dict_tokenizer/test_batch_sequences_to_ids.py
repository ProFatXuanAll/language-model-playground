r"""Test `lmp.tokenizer.CharDictTokenizer.batch_sequences_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_dict_tokenizer/test_batch_sequences_to_ids.py
"""
...
class TestBatchSequencesToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharDictTokenizer.batch_sequences_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharDictTokenizer.batch_sequences_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
