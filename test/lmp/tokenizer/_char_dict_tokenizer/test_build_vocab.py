r"""Test `lmp.tokenizer.CharDictTokenizer.build_vocab`.

Usage:
    python -m unittest test.lmp.tokenizer._char_dict_tokenizer.test_build_vocab
"""
...
class TestBuildVocab(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharDictTokenizer.build_vocab),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
