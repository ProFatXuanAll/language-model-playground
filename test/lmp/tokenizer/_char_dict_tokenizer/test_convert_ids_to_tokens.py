r"""Test `lmp.tokenizer.CharDictTokenizer.convert_ids_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_dict_tokenizer/test_convert_ids_to_tokens.py
"""
...
class TestConvertIdsToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharDictTokenizer.convert_ids_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharDictTokenizer.convert_ids_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
