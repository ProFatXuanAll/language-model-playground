r"""Test `lmp.tokenizer.CharDictTokenizer.batch_tokens_to_sequences`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_dict_tokenizer/test_batch_tokens_to_sequences.py
"""
...
class TestBatchTokensToSequences(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharDictTokenizer.batch_tokens_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharDictTokenizer.batch_tokens_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
