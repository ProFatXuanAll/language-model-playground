r"""Test `lmp.tokenizer.CharDictTokenizer.batch_sequences_to_tokens`.
...
class TestBatchSequencesToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharDictTokenizer.batch_sequences_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharDictTokenizer.batch_sequences_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
