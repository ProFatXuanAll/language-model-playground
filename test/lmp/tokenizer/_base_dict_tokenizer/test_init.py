r"""Test `lmp.tokenizer.BaseDictTokenizer.__init__`.

Usage:
    python -m unittest test/lmp/tokenizer/_base_dict_tokenizer/test_init.py
"""
...
from lmp.tokenizer import BaseDictTokenizer, BaseTokenizer


class TestInit(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseDictTokenizer.__init__`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.__init__),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
