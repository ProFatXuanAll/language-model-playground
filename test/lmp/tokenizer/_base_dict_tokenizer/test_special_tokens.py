r"""Test `lmp.tokenizer.BaseDictTokenizer.special_tokens`.
...
class TestSpecialTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseDictTokenizer.special_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.special_tokens),
            inspect.Signature(
                parameters=None,
    ...
    def test_yield_value(self):
        ...
        self.assertIsInstance(
            BaseDictTokenizer.special_tokens(),
            Iterator,
            msg=msg
        )
