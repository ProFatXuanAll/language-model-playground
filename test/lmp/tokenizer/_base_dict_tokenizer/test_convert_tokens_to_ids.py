r"""Test `lmp.tokenizer.BaseDictTokenizer.convert_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_dict_tokenizer/test_convert_tokens_to_ids.py
"""
...
class TestConvertTokensToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.BaseDictTokenizer.convert_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseDictTokenizer.convert_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
