r"""Test `lmp.tokenizer.BaseTokenizer.batch_tokens_to_sequences`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_tokenizer/test_batch_tokens_to_sequences.py
"""
...
class TestBatchTokensToSequences(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.BaseTokenizer.batch_tokens_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseTokenizer.batch_tokens_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_abstract_method(self):
        ...
        class SubClassTokenizer(BaseTokenizer):
            r"""Intented to not implement `batch_tokens_to_sequences`."""
