r"""Test `lmp.tokenizer.BaseTokenizer.batch_sequences_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_base_tokenizer/test_batch_sequences_to_tokens.py
"""
...
class TestBatchSequencesToTokens(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.BaseTokenizer.batch_sequences_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(BaseTokenizer.batch_sequences_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
