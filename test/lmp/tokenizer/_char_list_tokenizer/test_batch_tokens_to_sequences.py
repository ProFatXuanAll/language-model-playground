r"""Test `lmp.tokenizer.CharListTokenizer.batch_tokens_to_sequences`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_list_tokenizer/test_batch_tokens_to_sequences.py
"""
...
class TestBatchTokensToSequences(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharListTokenizer.batch_tokens_to_sequences`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharListTokenizer.batch_tokens_to_sequences),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
