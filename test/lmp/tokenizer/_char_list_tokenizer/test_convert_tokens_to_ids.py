r"""Test `lmp.tokenizer.CharListTokenizer.convert_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_list_tokenizer/test_convert_tokens_to_ids.py
"""
...
class TestConvertTokensToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharListTokenizer.convert_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharListTokenizer.convert_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_invalid_input_tokens(self):
        ...
        examples = (
            0, 1, -1, 0.0, 1.0, math.nan, math.inf, True, False, object(),
            lambda x: x, type, None, 0j, 1j, NotImplemented, ...,
        )
