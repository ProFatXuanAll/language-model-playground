r"""Test `lmp.tokenizer.CharListTokenizer.batch_ids_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_list_tokenizer/test_batch_ids_to_tokens.py
"""
...
class TestBatchIdsToTokens(unittest.TestCase):
    r"""Test Case for `lmp.tokenizer.CharListTokenizer.batch_ids_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharListTokenizer.batch_ids_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
    ...
    def test_function(self):
        ...
        for batch_token_ids, ans_batch_token_ids in examples:
            for tokenizer in self.tokenizers:
                self.assertEqual(
                    tokenizer.batch_ids_to_tokens(
                        batch_token_ids=batch_token_ids
