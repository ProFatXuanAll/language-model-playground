r"""Test `lmp.tokenizer.CharListTokenizer.batch_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_char_list_tokenizer/test_batch_tokens_to_ids.py
"""
...
class TestBatchTokensToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.CharListTokenizer.batch_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(CharListTokenizer.batch_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
