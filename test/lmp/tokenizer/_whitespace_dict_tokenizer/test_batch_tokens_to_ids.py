r"""Test `lmp.tokenizer.WhitespaceDictTokenizer.batch_tokens_to_ids`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_dict_tokenizer/test_batch_tokens_to_ids.py
"""
...
class TestBatchTokensToIds(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceDictTokenizer.batch_tokens_to_ids`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceDictTokenizer.batch_tokens_to_ids),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
