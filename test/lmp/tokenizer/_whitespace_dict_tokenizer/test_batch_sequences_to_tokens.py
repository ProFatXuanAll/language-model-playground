r"""Test `lmp.tokenizer.WhitespaceDictTokenizer.batch_sequences_to_tokens`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_dict_tokenizer/test_batch_sequences_to_tokens.py
"""
...
class TestBatchSequencesToTokens(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceDictTokenizer.batch_sequences_to_tokens`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(
                WhitespaceDictTokenizer.batch_sequences_to_tokens),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
