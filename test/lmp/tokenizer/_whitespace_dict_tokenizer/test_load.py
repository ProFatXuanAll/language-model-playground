...
Usage:
    python -m unittest test.lmp.tokenizer._whitespace_dict_tokenizer.test_load
"""
    ...
    def test_invalid_input_experiment(self):
        ...
        for invalid_input in examples:
            with self.assertRaises(
                ...
                WhitespaceDictTokenizer.load(experiment=invalid_input)
    ...
    def test_experiment_does_not_exist(self):
        ...
        for experiment in examples:
            with self.assertRaises(FileNotFoundError, msg=msg1) as ctx_man:
                WhitespaceDictTokenizer.load(experiment=experiment)
    ...
    def test_load_result(self):
        ...
        for obj in examples:
            try:
                ...
                tokenizer = WhitespaceDictTokenizer.load(
                    experiment=self.__class__.experiment
                )

                self.assertIsInstance(
                    tokenizer, WhitespaceDictTokenizer, msg=msg)
