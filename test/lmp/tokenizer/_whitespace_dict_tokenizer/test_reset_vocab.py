r"""Test `lmp.tokenizer.WhitespaceDictTokenizer.reset_vocab`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_dict_tokenizer/test_reset_vocab.py
"""
...
class TestResetVocab(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceDictTokenizer.reset_vocab),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
