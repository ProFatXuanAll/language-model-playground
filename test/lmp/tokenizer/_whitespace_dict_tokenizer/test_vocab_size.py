r"""Test `lmp.tokenizer.WhitespaceDictTokenizer.vocab_size`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_dict_tokenizer/test_vocab_size.py
"""
...
class TestVocabSize(unittest.TestCase):
    ...
    def test_signature(self):
        ...
        self.assertTrue(
            inspect.isdatadescriptor(WhitespaceDictTokenizer.vocab_size),
            msg=msg
        )
        self.assertFalse(
            inspect.isfunction(WhitespaceDictTokenizer.vocab_size),
            msg=msg
        )
        self.assertFalse(
            inspect.ismethod(WhitespaceDictTokenizer.vocab_size),
            msg=msg
        )
