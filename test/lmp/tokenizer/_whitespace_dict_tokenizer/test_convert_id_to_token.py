r"""Test `lmp.tokenizer.WhitespaceDictTokenizer.convert_id_to_token`.

Usage:
    python -m unittest \
        test/lmp/tokenizer/_whitespace_dict_tokenizer/test_convert_id_to_token.py
"""
...
class TestConvertIdToToken(unittest.TestCase):
    r"""Test case for `lmp.tokenizer.WhitespaceDictTokenizer.convert_id_to_token`."""
    ...
    def test_signature(self):
        ...
        self.assertEqual(
            inspect.signature(WhitespaceDictTokenizer.convert_id_to_token),
            inspect.Signature(
                parameters=[
                    inspect.Parameter(
                        name='self',
