"""Test save and load operation for training configuration.
...
def test_save(
  ...
  """Test save operation for training configuration file."""
...
def test_load(
  ...
  """Test load operation for training configuration file."""
  args = argparse.Namespace(a=1, b=2, c=3)
