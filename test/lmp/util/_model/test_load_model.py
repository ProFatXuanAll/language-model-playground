    ...
    def setUpClass(cls):
        ...
        cls.model_parameters = {
            ...
            'model': [
                ...
                ('att_rnn', lmp.model.BaseSelfAttentionRNNModel),
                ('att_gru', lmp.model.SelfAttentionGRUModel),
                ('att_lstm', lmp.model.SelfAttentionLSTMModel),
                ('att_res_rnn', lmp.model.BaseSelfAttentionResRNNModel),
                ('att_res_gru', lmp.model.SelfAttentionResGRUModel),
                ('att_res_lstm', lmp.model.SelfAttentionResLSTMModel),
            ],
